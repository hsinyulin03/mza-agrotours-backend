...
public class PermisoSeeder implements CommandLineRunner {
    ...
    private static final Map<PermisoCodigo, SeedPermiso> SEEDS = Map.ofEntries(
            ...
            entry(PermisoCodigo.LEER_ESTABLECIMIENTO,
                    new SeedPermiso(TipoPermisoNombre.ADMIN, "Lectura de establecimientos", "Ver establecimientos")),
            entry(PermisoCodigo.GESTIONAR_ESTABLECIMIENTO,
                    new SeedPermiso(TipoPermisoNombre.ADMIN, "Gestionar establecimientos", "Crear, modificar y eliminar establecimientos")),
            entry(PermisoCodigo.LEER_CULTIVOS,
                    new SeedPermiso(TipoPermisoNombre.ADMIN, "Lectura de cultivos", "Ver cultivos")),
            entry(PermisoCodigo.GESTIONAR_CULTIVOS,
                    new SeedPermiso(TipoPermisoNombre.ADMIN, "Gestionar cultivos", "Crear, modificar y eliminar cultivos")),
            entry(PermisoCodigo.LEER_RECETAS,
                    new SeedPermiso(TipoPermisoNombre.ADMIN, "Lectura de recetas", "Ver recetas")),
            entry(PermisoCodigo.GESTIONAR_RECETAS,
                    new SeedPermiso(TipoPermisoNombre.ADMIN, "Gestionar recetas", "Crear, modificar y eliminar recetas")),
